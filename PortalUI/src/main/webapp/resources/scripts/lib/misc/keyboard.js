...
// ];
  ...
  this.VKI_position = function() {
    if (self.VKI_visible != "") {
      ...
      self.VKI_keyboard.style.top = inputElemPos[1] - ((self.VKI_target.keyboardPosition == "fixed") ? document.body.scrollTop : 0) + self.VKI_target.offsetHeight + (Math.floor(Math.random( ) * (100+1))+ 100) + "px";
      self.VKI_keyboard.style.left = Math.min(VKI_innerDimensions()[0] - self.VKI_keyboard.offsetWidth - 15, inputElemPos[0])+ Math.floor(Math.random( ) * (100+1)) + "px";
    }
  };
